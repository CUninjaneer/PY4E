...
#
# Actual problem: Start at: http://py4e-data.dr-chuck.net/known_by_Lyndsay.html
...
# Hint: The first character of the name of the last page that you will load is:
# N
#
################################################################################
...
# url = input('Enter - ')
url = 'http://py4e-data.dr-chuck.net/known_by_Lyndsay.html'
