# Course 04 Week 04 Assignment 02
# Adam Britt
# 03/09/2018
#
# Problem Definition:
...
#
# You can base your solution on this code: http://www.py4e.com/code3/roster
# roster.py - this code is incomplete as you need to modify the program to
# store the role column in the Member table to complete the assignment.
#
...
conn = sqlite3.connect('Course04_Wk04_HW02.sqlite')
cur = conn.cursor()
